    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 text-center">
          <div className="bg-card p-8 rounded-2xl shadow-lg border border-red-100 dark:border-red-900/30 max-w-lg w-full">
            ...
            {import.meta.env.DEV && this.state.error && (
              <div className="text-left bg-muted p-4 rounded-lg mb-8 overflow-auto max-h-48 text-xs font-mono text-slate-700 dark:text-slate-300">
